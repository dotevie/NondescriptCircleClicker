...
void haxe_crypto_BaseCode_new(haxe__crypto__BaseCode r0,haxe__io__Bytes r1) {
	...
	r5 = 1;
	r5 = r5 << r4;
	if( r2 == r5 ) goto label$adfabbb_1_16;
	label$adfabbb_1_14:
	r6 = (String)s$786d1e9;
...
haxe__io__Bytes haxe_crypto_BaseCode_decodeBytes(haxe__crypto__BaseCode r0,haxe__io__Bytes r1) {
	...
	r11 = 0;
	label$adfabbb_3_16:
	if( r11 >= r6 ) goto label$adfabbb_3_56;
	label$adfabbb_3_18:
	r13 = 8;
	if( r9 >= r13 ) goto label$adfabbb_3_45;
	r12 = r9 + r2;
	r9 = r12;
	r12 = r8 << r2;
	r8 = r12;
	...
	label$adfabbb_3_38:
	r15 = -1;
	if( r12 != r15 ) goto label$adfabbb_3_42;
	r16 = (String)s$BaseCode_invalid_encoded_char;
