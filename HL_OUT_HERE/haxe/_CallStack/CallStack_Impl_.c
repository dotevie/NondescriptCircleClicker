...
hl__types__ArrayObj haxe__CallStack_CallStack_Impl__callStack() {
	...
	int r0, r2;
	r1 = NULL;
	r0 = hl_call_stack_raw(r1);
	r3 = &t$hl_symbol;
	r1 = hl_alloc_array(r3,r0);
	r2 = hl_call_stack_raw(r1);
	r5 = NULL;
	r4 = haxe_NativeStackTrace_toHaxe(r1,r5);
	return r4;
}
...
hl__types__ArrayObj haxe__CallStack_CallStack_Impl__exceptionStack(bool* r0) {
	...
	r1 = *r0;
	label$e26c8ce_2_4:
	r3 = haxe_NativeStackTrace_exceptionStack();
	r4 = NULL;
...
bool haxe__CallStack_CallStack_Impl__equalItems(venum* r0,venum* r1) {
	...
	switch(r4) {
		...
		case 1:
			...
			if( r7 == r6 || (r7 && r6 && String___compare(r7,(vdynamic*)r6) == 0) ) goto label$e26c8ce_5_33;
			r3 = false;
		...
		case 2:
			...
			if( r7 != r6 && (!r7 || !r6 || String___compare(r7,(vdynamic*)r6) != 0) ) goto label$e26c8ce_5_57;
			if( r5 != r4 ) goto label$e26c8ce_5_57;
			if( r12 != r11 && (!r12 || !r11 || (r12->v.i != r11->v.i)) ) goto label$e26c8ce_5_57;
		...
		case 3:
			...
			if( r9 != r6 && (!r9 || !r6 || String___compare(r9,(vdynamic*)r6) != 0) ) goto label$e26c8ce_5_78;
			if( r8 == r7 || (r8 && r7 && String___compare(r8,(vdynamic*)r7) == 0) ) goto label$e26c8ce_5_76;
			r3 = false;
		...
		case 4:
			...
			if( r12 == r11 || (r12 && r11 && (r12->v.i == r11->v.i)) ) goto label$e26c8ce_5_94;
			r3 = false;
