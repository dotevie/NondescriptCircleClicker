...
String haxe_io_Path_withoutDirectory(String r0) {
	String r2;
	haxe__io__Path r1;
...
String haxe_io_Path_normalize(String r0) {
	...
	r0 = r3;
	if( r3 != r1 && (!r3 || !r1 || String___compare(r3,(vdynamic*)r1) != 0) ) goto label$aa1abd3_6_9;
	return r1;
	label$aa1abd3_6_9:
	r8 = &t$String;
	r9 = 0;
	...
	r12 = r10->length;
	if( r9 >= r12 ) goto label$aa1abd3_6_68;
	r12 = r10->length;
	if( ((unsigned)r9) < ((unsigned)r12) ) goto label$aa1abd3_6_24;
	r3 = NULL;
	goto label$aa1abd3_6_27;
	label$aa1abd3_6_24:
	r7 = r10->array;
	r6 = ((vdynamic**)(r7 + 1))[r9];
	r3 = (String)r6;
	...
	if( r3 != r13 && (!r3 || !r13 || String___compare(r3,(vdynamic*)r13) != 0) ) goto label$aa1abd3_6_49;
	if( r4 == NULL ) hl_null_access();
	r11 = r4->length;
	r12 = 0;
	if( r12 >= r11 ) goto label$aa1abd3_6_49;
	r11 = r4->length;
	r12 = 1;
	r11 = r11 - r12;
	r12 = r4->length;
	if( ((unsigned)r11) < ((unsigned)r12) ) goto label$aa1abd3_6_41;
	r5 = NULL;
	goto label$aa1abd3_6_44;
	label$aa1abd3_6_41:
	r7 = r4->array;
	...
	label$aa1abd3_6_44:
	r13 = (String)s$58b9e70;
	if( r5 == r13 || (r5 && r13 && String___compare(r5,(vdynamic*)r13) == 0) ) goto label$aa1abd3_6_49;
	r6 = hl_types_ArrayObj_pop(r4);
	r5 = (String)r6;
	goto label$aa1abd3_6_67;
	label$aa1abd3_6_49:
	r13 = (String)s$;
	if( r3 != r13 && (!r3 || !r13 || String___compare(r3,(vdynamic*)r13) != 0) ) goto label$aa1abd3_6_63;
	if( r4 == NULL ) hl_null_access();
	r11 = r4->length;
	r12 = 0;
	if( r12 < r11 ) goto label$aa1abd3_6_61;
	if( r0 == NULL ) hl_null_access();
	r11 = 0;
	...
	r15->v.i = r11;
	if( r14 != r15 && (!r14 || !r15 || (r14->v.i != r15->v.i)) ) goto label$aa1abd3_6_62;
	label$aa1abd3_6_61:
	...
	if( r3 == r13 || (r3 && r13 && String___compare(r3,(vdynamic*)r13) == 0) ) goto label$aa1abd3_6_67;
	if( r4 == NULL ) hl_null_access();
	r11 = hl_types_ArrayObj_push(r4,((vdynamic*)r3));
	label$aa1abd3_6_67:
	goto label$aa1abd3_6_16;
	label$aa1abd3_6_68:
	if( r4 == NULL ) hl_null_access();
	r3 = hl_types_ArrayObj_join(r4,r1);
	...
	r12 = r5->length;
	if( r9 >= r12 ) goto label$aa1abd3_6_140;
	r11 = r9;
	++r9;
	r19 = r5->bytes;
	r22 = 1;
	...
	r23 = 55296;
	if( r12 < r23 ) goto label$aa1abd3_6_104;
	r23 = 56319;
	if( r23 < r12 ) goto label$aa1abd3_6_104;
	r21 = r5->bytes;
	r23 = 55232;
	r22 = r12 - r23;
	r23 = 10;
	...
	label$aa1abd3_6_104:
	r24 = 65536;
	if( r12 < r24 ) goto label$aa1abd3_6_107;
	++r9;
	label$aa1abd3_6_107:
	switch(r12) {
		default:
		...
		case 57:
			r25 = false;
			r17 = r25;
			if( !r18 ) goto label$aa1abd3_6_116;
			...
			goto label$aa1abd3_6_139;
		case 47:
			if( r17 ) goto label$aa1abd3_6_123;
			r25 = true;
			r18 = r25;
			goto label$aa1abd3_6_133;
			label$aa1abd3_6_123:
			r25 = false;
			r17 = r25;
			if( !r18 ) goto label$aa1abd3_6_131;
			if( r16 == NULL ) hl_null_access();
			r20 = (String)s$6666cd7;
			StringBuf_add(r16,((vdynamic*)r20));
			r25 = false;
...
String haxe_io_Path_addTrailingSlash(String r0) {
	...
	r1 = r0->length;
	r3 = 0;
	if( r1 != r3 ) goto label$aa1abd3_7_6;
	r2 = (String)s$6666cd7;
	return r2;
	label$aa1abd3_7_6:
	r4 = (String)s$6666cd7;
	...
	if( r1 >= r3 ) goto label$aa1abd3_7_21;
	r6 = r0->length;
	r7 = 1;
	r6 = r6 - r7;
	if( r3 == r6 ) goto label$aa1abd3_7_20;
	r4 = (String)s$28d397e;
	...
	r7 = 1;
	r6 = r6 - r7;
	if( r1 == r6 ) goto label$aa1abd3_7_28;
	r4 = (String)s$6666cd7;
	r2 = String___add__(r0,r4);
	return r2;
	label$aa1abd3_7_28:
...
String haxe_io_Path_removeTrailingSlashes(String r0) {
	...
	label$aa1abd3_8_0:
	r1 = true;
	if( !r1 ) goto label$aa1abd3_8_19;
	if( r0 == NULL ) hl_null_access();
	r4 = r0->length;
	r5 = 1;
	r4 = r4 - r5;
	r2 = String_charCodeAt(r0,r4);
	if( r2 ) goto label$aa1abd3_8_10;
	goto label$aa1abd3_8_19;
	label$aa1abd3_8_10:
	r4 = r2 ? r2->v.i : 0;
	switch(r4) {
		default:
