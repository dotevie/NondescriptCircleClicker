...
String haxe_io_Input_readLine(haxe__io__Input r0) {
	...
	hl_trap(trap$0,r3,label$03d8419_6_42);
	label$03d8419_6_3:
	r4 = true;
	if( !r4 ) goto label$03d8419_6_24;
	r6 = ((int (*)(haxe__io__Input))r0->$type->vobj_proto[0])(r0);
	r5 = r6;
	r7 = 10;
	if( r6 != r7 ) goto label$03d8419_6_11;
	goto label$03d8419_6_24;
	label$03d8419_6_11:
	if( r1 == NULL ) hl_null_access();
	r6 = r1->pos;
	r7 = r1->size;
	if( r6 != r7 ) goto label$03d8419_6_17;
	r6 = 0;
	...
	*(unsigned char*)(r8 + r7) = (unsigned char)r5;
	...
	r12->v.i = r6;
	if( r11 != r12 && (!r11 || !r12 || (r11->v.i != r12->v.i)) ) goto label$03d8419_6_40;
	r6 = 0;
	r7 = -1;
	...
	r6 = r9->length;
	r7 = 0;
	if( r6 != r7 ) goto label$03d8419_6_54;
	...
	r6 = r9->length;
	r7 = 0;
	if( r6 != r7 ) goto label$03d8419_6_75;
	hl_throw((vdynamic*)r14);
	label$03d8419_6_75:
	goto label$03d8419_6_77;
	label$03d8419_6_76:
...
int haxe_io_Input_readInt16(haxe__io__Input r0) {
	...
	r4 = r0->bigEndian;
	if( !r4 ) goto label$03d8419_7_8;
	r6 = 8;
	r5 = r1 << r6;
	r3 = r2 | r5;
	goto label$03d8419_7_11;
	label$03d8419_7_8:
	r6 = 8;
	r5 = r2 << r6;
	r3 = r1 | r5;
	...
	r5 = r3 & r6;
	r6 = 0;
	if( r5 == r6 ) goto label$03d8419_7_18;
	r6 = 65536;
	r5 = r3 - r6;
	return r5;
	label$03d8419_7_18:
