...
venum* sys_thread_EventLoop_progress(sys__thread__EventLoop r0) {
	...
	if( !r9 ) goto label$93e7ec3_1_17;
	goto label$93e7ec3_1_9;
	label$93e7ec3_1_17:
	r13 = r0->regularEvents;
	label$93e7ec3_1_18:
	if( !r13 ) goto label$93e7ec3_1_47;
	if( r13 == NULL ) hl_null_access();
	r11 = r13->nextRunTime;
	if( !(r1 >= r11) ) goto label$93e7ec3_1_38;
	if( r3 == NULL ) hl_null_access();
	r17 = r6;
	++r6;
	r18 = r3->length;
	if( ((unsigned)r17) < ((unsigned)r18) ) goto label$93e7ec3_1_29;
	...
	r11 = -2.;
	r7 = r11;
	goto label$93e7ec3_1_44;
	label$93e7ec3_1_38:
	r15 = -1.;
	if( r7 == r15 ) goto label$93e7ec3_1_42;
	r11 = r13->nextRunTime;
	if( !(r11 < r7) ) goto label$93e7ec3_1_44;
	label$93e7ec3_1_42:
	r11 = r13->nextRunTime;
	r7 = r11;
	label$93e7ec3_1_44:
	...
	r18 = r6;
	label$93e7ec3_1_51:
	if( r17 >= r18 ) goto label$93e7ec3_1_84;
	r19 = r17;
	++r17;
	if( r3 == NULL ) hl_null_access();
	r21 = r3->length;
	if( ((unsigned)r19) < ((unsigned)r21) ) goto label$93e7ec3_1_60;
	r14 = NULL;
	goto label$93e7ec3_1_63;
	label$93e7ec3_1_60:
	r4 = r3->array;
	...
	r9 = r14->cancelled;
	if( r9 ) goto label$93e7ec3_1_77;
	r21 = r3->length;
	if( ((unsigned)r19) < ((unsigned)r21) ) goto label$93e7ec3_1_70;
	r14 = NULL;
	goto label$93e7ec3_1_73;
	label$93e7ec3_1_70:
	r4 = r3->array;
	r22 = ((vdynamic**)(r4 + 1))[r19];
	r14 = (sys__thread___EventLoop__RegularEvent)r22;
	...
	r21 = r24->length;
	if( r19 >= r21 ) goto label$93e7ec3_1_126;
	r21 = r24->length;
	if( ((unsigned)r19) < ((unsigned)r21) ) goto label$93e7ec3_1_102;
	r23 = NULL;
	...
	r20 = r19;
	++r19;
	if( r23 ) goto label$93e7ec3_1_109;
	goto label$93e7ec3_1_126;
	label$93e7ec3_1_109:
	if( r16 == NULL ) hl_null_access();
	r27 = r6;
	++r6;
	r28 = r16->length;
	if( ((unsigned)r27) < ((unsigned)r28) ) goto label$93e7ec3_1_115;
	...
	r26 = NULL;
	r28 = r25->length;
	if( ((unsigned)r20) < ((unsigned)r28) ) goto label$93e7ec3_1_123;
	hl_types_ArrayObj___expand(r25,r20);
	label$93e7ec3_1_123:
	r4 = r25->array;
	((vclosure**)(r4 + 1))[r20] = r26;
	goto label$93e7ec3_1_94;
	label$93e7ec3_1_126:
	r20 = 0;
	r0->oneTimeEventsIdx = r20;
	r20 = r0->promisedEventsCount;
	r21 = 0;
	if( r20 > r21 ) goto label$93e7ec3_1_133;
	r9 = false;
	goto label$93e7ec3_1_134;
	label$93e7ec3_1_133:
	r9 = true;
	label$93e7ec3_1_134:
	r8 = r0->mutex;
	...
	r21 = r6;
	label$93e7ec3_1_138:
	if( r20 >= r21 ) goto label$93e7ec3_1_159;
	r27 = r20;
	++r20;
	if( r16 == NULL ) hl_null_access();
	r29 = r16->length;
	if( ((unsigned)r27) < ((unsigned)r29) ) goto label$93e7ec3_1_147;
	r23 = NULL;
	goto label$93e7ec3_1_150;
	label$93e7ec3_1_147:
	r4 = r16->array;
	...
	r23 = NULL;
	r29 = r16->length;
	if( ((unsigned)r27) < ((unsigned)r29) ) goto label$93e7ec3_1_156;
	hl_types_ArrayObj___expand(r16,r27);
	label$93e7ec3_1_156:
	r4 = r16->array;
	((vclosure**)(r4 + 1))[r27] = r23;
	goto label$93e7ec3_1_138;
	label$93e7ec3_1_159:
	r30 = r0->isMainThread;
	if( !r30 ) goto label$93e7ec3_1_167;
	r11 = haxe_MainLoop_tick();
	r30 = haxe_MainLoop_hasEvents();
	if( !r30 ) goto label$93e7ec3_1_167;
	++r6;
	if( !(r11 < r7) ) goto label$93e7ec3_1_167;
	r7 = r11;
	label$93e7ec3_1_167:
	r28 = 0;
	if( r28 >= r6 ) goto label$93e7ec3_1_171;
	r11 = -2.;
	r7 = r11;
	label$93e7ec3_1_171:
	r31 = -2.;
	if( r31 == r7 ) goto label$93e7ec3_1_181;
	r31 = -1.;
	if( r31 == r7 ) goto label$93e7ec3_1_183;
	if( !r9 ) goto label$93e7ec3_1_179;
	r12 = hl_alloc_dynamic(&t$_f64);
	r12->v.d = r7;
	...
	return r32;
	label$93e7ec3_1_183:
	if( !r9 ) goto label$93e7ec3_1_187;
	r12 = NULL;
	r32 = hl_alloc_enum(&t$sys_thread_NextEventTime,2);
	((sys_thread_NextEventTime_AnyTime*)r32)->p0 = r12;
	return r32;
...
void sys_thread_EventLoop_loop(sys__thread__EventLoop r0) {
	...
	label$93e7ec3_2_8:
	r7 = true;
	if( !r7 ) goto label$93e7ec3_2_198;
	r8 = hl_sys_time();
	r9 = r1;
	r4 = 0;
	r10 = -1.;
	...
	if( !r7 ) goto label$93e7ec3_2_25;
	goto label$93e7ec3_2_17;
	label$93e7ec3_2_25:
	r15 = r0->regularEvents;
	label$93e7ec3_2_26:
	if( !r15 ) goto label$93e7ec3_2_55;
	if( r15 == NULL ) hl_null_access();
	r13 = r15->nextRunTime;
	if( !(r8 >= r13) ) goto label$93e7ec3_2_46;
	if( r9 == NULL ) hl_null_access();
	r19 = r4;
	++r4;
	r20 = r9->length;
	if( ((unsigned)r19) < ((unsigned)r20) ) goto label$93e7ec3_2_37;
	...
	r13 = -2.;
	r10 = r13;
	goto label$93e7ec3_2_52;
	label$93e7ec3_2_46:
	r17 = -1.;
	if( r10 == r17 ) goto label$93e7ec3_2_50;
	r13 = r15->nextRunTime;
	if( !(r13 < r10) ) goto label$93e7ec3_2_52;
	label$93e7ec3_2_50:
	r13 = r15->nextRunTime;
	r10 = r13;
	label$93e7ec3_2_52:
	...
	r20 = r4;
	label$93e7ec3_2_59:
	if( r19 >= r20 ) goto label$93e7ec3_2_92;
	r21 = r19;
	++r19;
	if( r9 == NULL ) hl_null_access();
	r23 = r9->length;
	if( ((unsigned)r21) < ((unsigned)r23) ) goto label$93e7ec3_2_68;
	r16 = NULL;
	goto label$93e7ec3_2_71;
	label$93e7ec3_2_68:
	r2 = r9->array;
	...
	if( r16 == NULL ) hl_null_access();
	r7 = r16->cancelled;
	if( r7 ) goto label$93e7ec3_2_85;
	r23 = r9->length;
	if( ((unsigned)r21) < ((unsigned)r23) ) goto label$93e7ec3_2_78;
	r16 = NULL;
	goto label$93e7ec3_2_81;
	label$93e7ec3_2_78:
	r2 = r9->array;
	r24 = ((vdynamic**)(r2 + 1))[r21];
	r16 = (sys__thread___EventLoop__RegularEvent)r24;
	...
	r23 = r26->length;
	if( r21 >= r23 ) goto label$93e7ec3_2_131;
	r23 = r26->length;
	if( ((unsigned)r21) < ((unsigned)r23) ) goto label$93e7ec3_2_107;
	r25 = NULL;
	goto label$93e7ec3_2_110;
	label$93e7ec3_2_107:
	r2 = r26->array;
	r24 = ((vdynamic**)(r2 + 1))[r21];
	r25 = (vclosure*)r24;
	...
	r22 = r21;
	++r21;
	if( r25 ) goto label$93e7ec3_2_114;
	goto label$93e7ec3_2_131;
	label$93e7ec3_2_114:
	if( r18 == NULL ) hl_null_access();
	r29 = r4;
	++r4;
	r30 = r18->length;
	if( ((unsigned)r29) < ((unsigned)r30) ) goto label$93e7ec3_2_120;
	...
	r28 = NULL;
	r30 = r27->length;
	if( ((unsigned)r22) < ((unsigned)r30) ) goto label$93e7ec3_2_128;
	hl_types_ArrayObj___expand(r27,r22);
	label$93e7ec3_2_128:
	r2 = r27->array;
	((vclosure**)(r2 + 1))[r22] = r28;
	goto label$93e7ec3_2_99;
	label$93e7ec3_2_131:
	r22 = 0;
	r0->oneTimeEventsIdx = r22;
	r22 = r0->promisedEventsCount;
	r23 = 0;
	if( r22 > r23 ) goto label$93e7ec3_2_138;
	r7 = false;
	goto label$93e7ec3_2_139;
	label$93e7ec3_2_138:
	r7 = true;
	label$93e7ec3_2_139:
	r11 = r0->mutex;
	...
	r23 = r4;
	label$93e7ec3_2_143:
	if( r22 >= r23 ) goto label$93e7ec3_2_164;
	r29 = r22;
	++r22;
	if( r18 == NULL ) hl_null_access();
	r31 = r18->length;
	if( ((unsigned)r29) < ((unsigned)r31) ) goto label$93e7ec3_2_152;
	r25 = NULL;
	goto label$93e7ec3_2_155;
	label$93e7ec3_2_152:
	r2 = r18->array;
	...
	r25 = NULL;
	r31 = r18->length;
	if( ((unsigned)r29) < ((unsigned)r31) ) goto label$93e7ec3_2_161;
	hl_types_ArrayObj___expand(r18,r29);
	label$93e7ec3_2_161:
	r2 = r18->array;
	((vclosure**)(r2 + 1))[r29] = r25;
	goto label$93e7ec3_2_143;
	label$93e7ec3_2_164:
	r32 = r0->isMainThread;
	if( !r32 ) goto label$93e7ec3_2_172;
	r13 = haxe_MainLoop_tick();
	r32 = haxe_MainLoop_hasEvents();
	if( !r32 ) goto label$93e7ec3_2_172;
	++r4;
	if( !(r13 < r10) ) goto label$93e7ec3_2_172;
	r10 = r13;
	label$93e7ec3_2_172:
	r30 = 0;
	if( r30 >= r4 ) goto label$93e7ec3_2_176;
	r13 = -2.;
	r10 = r13;
	label$93e7ec3_2_176:
	r33 = -2.;
	if( r33 == r10 ) goto label$93e7ec3_2_189;
	r33 = -1.;
	if( r33 == r10 ) goto label$93e7ec3_2_190;
	r34 = hl_sys_time();
	r33 = r10 - r34;
	r12 = r0->waitLock;
	if( r12 == NULL ) hl_null_access();
	...
	goto label$93e7ec3_2_197;
	label$93e7ec3_2_189:
	goto label$93e7ec3_2_197;
	label$93e7ec3_2_190:
	if( !r7 ) goto label$93e7ec3_2_196;
	r12 = r0->waitLock;
	if( r12 == NULL ) hl_null_access();
	r14 = NULL;
	r35 = sys_thread_Lock_wait(r12,r14);
	goto label$93e7ec3_2_197;
	label$93e7ec3_2_196:
	goto label$93e7ec3_2_198;
	label$93e7ec3_2_197:
	goto label$93e7ec3_2_8;
	label$93e7ec3_2_198:
	return;
}
