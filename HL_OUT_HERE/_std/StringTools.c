...
String StringTools_htmlUnescape(String r0) {
	String r1, r3;
	hl__types__ArrayObj r2;
	if( r0 == NULL ) hl_null_access();
	r3 = (String)s$_gt_;
	r2 = String_split(r0,r3);
	if( r2 == NULL ) hl_null_access();
	r1 = (String)s$cedf8da;
	r1 = hl_types_ArrayObj_join(r2,r1);
	if( r1 == NULL ) hl_null_access();
	r3 = (String)s$_lt_;
	r2 = String_split(r1,r3);
	if( r2 == NULL ) hl_null_access();
	r1 = (String)s$524a507;
	r1 = hl_types_ArrayObj_join(r2,r1);
	if( r1 == NULL ) hl_null_access();
...
bool StringTools_startsWith(String r0,String r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r3 = r1->length;
	if( r2 < r3 ) goto label$de37252_3_19;
	r5 = r0->bytes;
	r2 = 0;
	r6 = r1->bytes;
	r3 = 0;
	...
	r3 = 0;
	if( r2 == r3 ) goto label$de37252_3_17;
	r4 = false;
	goto label$de37252_3_18;
	label$de37252_3_17:
	r4 = true;
	label$de37252_3_18:
	return r4;
...
bool StringTools_endsWith(String r0,String r1) {
	...
	if( r0 == NULL ) hl_null_access();
	r3 = r0->length;
	if( r3 < r2 ) goto label$de37252_4_20;
	r7 = r0->bytes;
	r4 = r3 - r2;
	r5 = 1;
	r4 = r4 << r5;
	...
	r5 = 0;
	if( r4 == r5 ) goto label$de37252_4_18;
	r6 = false;
	goto label$de37252_4_19;
	label$de37252_4_18:
	r6 = true;
	label$de37252_4_19:
	return r6;
...
bool StringTools_isSpace(String r0,int r1) {
	...
	r3 = r2 ? r2->v.i : 0;
	r4 = 8;
	if( r4 >= r3 ) goto label$de37252_5_8;
	r3 = r2 ? r2->v.i : 0;
	r4 = 14;
	if( r3 < r4 ) goto label$de37252_5_15;
	label$de37252_5_8:
	r3 = 32;
	r6 = hl_alloc_dynamic(&t$_i32);
	r6->v.i = r3;
	if( r2 == r6 || (r2 && r6 && (r2->v.i == r6->v.i)) ) goto label$de37252_5_13;
	r5 = false;
	goto label$de37252_5_14;
	label$de37252_5_13:
	r5 = true;
	label$de37252_5_14:
	return r5;
...
String StringTools_ltrim(String r0) {
	...
	r3 = 0;
	label$de37252_6_3:
	if( r3 >= r1 ) goto label$de37252_6_9;
	r5 = StringTools_isSpace(r0,r3);
	if( !r5 ) goto label$de37252_6_9;
	++r3;
	goto label$de37252_6_3;
	label$de37252_6_9:
	r4 = 0;
	if( r4 >= r3 ) goto label$de37252_6_16;
	if( r0 == NULL ) hl_null_access();
	r4 = r1 - r3;
	r6 = hl_alloc_dynamic(&t$_i32);
	r6->v.i = r4;
...
String StringTools_rtrim(String r0) {
	...
	r3 = 0;
	label$de37252_7_3:
	if( r3 >= r1 ) goto label$de37252_7_12;
	r4 = r1 - r3;
	r5 = 1;
	r4 = r4 - r5;
	r6 = StringTools_isSpace(r0,r4);
	if( !r6 ) goto label$de37252_7_12;
	++r3;
	goto label$de37252_7_3;
	label$de37252_7_12:
	r5 = 0;
	if( r5 >= r3 ) goto label$de37252_7_20;
	if( r0 == NULL ) hl_null_access();
	r4 = 0;
	r5 = r1 - r3;
...
String StringTools_lpad(String r0,String r1,int r2) {
	...
	r4 = r1->length;
	r6 = 0;
	if( r6 < r4 ) goto label$de37252_9_5;
	return r0;
	label$de37252_9_5:
	...
	r6 = 1;
	r4 = r4 >> r6;
	if( r4 >= r2 ) goto label$de37252_9_19;
	StringBuf_add(r7,((vdynamic*)r1));
	goto label$de37252_9_11;
	label$de37252_9_19:
...
String StringTools_hex(int r0,vdynamic* r1) {
	...
	label$de37252_11_2:
	r4 = true;
	if( !r4 ) goto label$de37252_11_18;
	...
	r0 = r6;
	r7 = 0;
	if( r7 < r6 ) goto label$de37252_11_17;
	goto label$de37252_11_18;
	label$de37252_11_17:
	goto label$de37252_11_2;
	label$de37252_11_18:
	if( !r1 ) goto label$de37252_11_28;
	label$de37252_11_19:
	if( r2 == NULL ) hl_null_access();
	r6 = r2->length;
	r7 = r1 ? r1->v.i : 0;
	if( r6 >= r7 ) goto label$de37252_11_28;
	r5 = (String)s$0;
	r5 = String___add__(r5,r2);
	r2 = r5;
	goto label$de37252_11_19;
	label$de37252_11_28:
	return r2;
}
