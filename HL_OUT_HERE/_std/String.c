...
String String_fromCharCode(int r0) {
	...
	int r1, r2, r7;
	r2 = 0;
	if( r0 < r2 ) goto label$306c77b_13_27;
	r2 = 65536;
	if( r0 >= r2 ) goto label$306c77b_13_27;
	r2 = 55296;
	if( r0 < r2 ) goto label$306c77b_13_15;
	r2 = 57343;
	if( r2 < r0 ) goto label$306c77b_13_15;
	r3 = (String)s$Invalid_unicode_char_;
	r1 = r0;
	r4 = &r1;
	r5 = hl_itos(r1,r4);
	...
	*(unsigned short*)(r5 + r1) = (unsigned short)r2;
	...
	label$306c77b_13_27:
	r2 = 1114112;
	if( r0 >= r2 ) goto label$306c77b_13_54;
	r1 = 6;
	r5 = hl_alloc_bytes(r1);
	r2 = 65536;
	r1 = r0 - r2;
