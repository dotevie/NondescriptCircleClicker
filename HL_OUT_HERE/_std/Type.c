...
extern String s$__constructor__;
bool hl_types_ArrayObj_remove(hl__types__ArrayObj,vdynamic*);
extern String s$__meta__;
extern String s$__name__;
extern String s$__type__;
extern String s$__implementedBy__;
...
vdynamic* Type_createEnum(hl__BaseType r0,String r1,hl__types__ArrayDyn r2) {
	...
	if( r8 ) goto label$9fea9d9_14_15;
...
vdynamic* Type_createEnumIndex(hl__BaseType r0,int r1,hl__types__ArrayDyn r2) {
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( r1 < r5 ) goto label$9fea9d9_15_20;
	label$9fea9d9_15_8:
	...
	hl_throw((vdynamic*)r7);
	label$9fea9d9_15_20:
	if( !r2 ) goto label$9fea9d9_15_25;
	if( r2 == NULL ) hl_null_access();
	r4 = hl_types_ArrayDyn_get_length(r2);
	r5 = 0;
	if( r4 != r5 ) goto label$9fea9d9_15_52;
	label$9fea9d9_15_25:
	r13 = r3->__evalues__;
	r5 = r13->size;
	if( r1 < r5 ) goto label$9fea9d9_15_30;
	r15 = NULL;
	goto label$9fea9d9_15_32;
	label$9fea9d9_15_30:
	r14 = r3->__evalues__;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	label$9fea9d9_15_32:
	if( r15 ) goto label$9fea9d9_15_51;
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$9fea9d9_15_44;
	r8 = NULL;
	goto label$9fea9d9_15_47;
	label$9fea9d9_15_44:
	r14 = r6->array;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	r8 = (String)r15;
	...
	if( r16 ) goto label$9fea9d9_15_78;
	r17 = r2->array;
	if( r17 == NULL ) hl_null_access();
	r4 = r17->length;
	r18 = &t$_dyn;
	...
	r19 = r17->length;
	label$9fea9d9_15_67:
	if( r5 >= r19 ) goto label$9fea9d9_15_77;
	r20 = r5;
	++r5;
	if( r12 == NULL ) hl_null_access();
	r17 = r12->array;
	...
	goto label$9fea9d9_15_67;
	label$9fea9d9_15_77:
	goto label$9fea9d9_15_83;
	label$9fea9d9_15_78:
	r17 = r2->array;
	...
	if( r11 ) goto label$9fea9d9_15_116;
	r7 = (String)s$Constructor_;
	r8 = r3->__ename__;
	r7 = String___add__(r7,r8);
	r8 = (String)s$5058f1a;
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->length;
	if( ((unsigned)r1) < ((unsigned)r5) ) goto label$9fea9d9_15_102;
	r8 = NULL;
	goto label$9fea9d9_15_105;
	label$9fea9d9_15_102:
	r14 = r6->array;
	r15 = ((vdynamic**)(r14 + 1))[r1];
	r8 = (String)r15;
	label$9fea9d9_15_105:
	r7 = String___add__(r7,r8);
...
hl__types__ArrayObj Type_getInstanceFields(hl__Class r0) {
	...
	label$9fea9d9_16_8:
	r7 = r1->size;
	if( r5 >= r7 ) goto label$9fea9d9_16_21;
	r8 = ((vbyte**)(r1 + 1))[r5];
	++r5;
	r9 = (String)hl_alloc_obj(&t$String);
	r9->bytes = r8;
	...
	goto label$9fea9d9_16_8;
	label$9fea9d9_16_21:
	return r3;
}

hl__types__ArrayObj Type_getClassFields(hl__Class r0) {
	String r9;
	...
	label$9fea9d9_17_6:
	r7 = r1->size;
	if( r5 >= r7 ) goto label$9fea9d9_17_19;
	r8 = ((vbyte**)(r1 + 1))[r5];
	++r5;
	r9 = (String)hl_alloc_obj(&t$String);
	r9->bytes = r8;
	...
	goto label$9fea9d9_17_6;
	label$9fea9d9_17_19:
	if( r2 == NULL ) hl_null_access();
	r9 = (String)s$__constructor__;
	r10 = hl_types_ArrayObj_remove(r2,((vdynamic*)r9));
	r9 = (String)s$__meta__;
	r10 = hl_types_ArrayObj_remove(r2,((vdynamic*)r9));
	r9 = (String)s$__name__;
	r10 = hl_types_ArrayObj_remove(r2,((vdynamic*)r9));
	r9 = (String)s$__type__;
	r10 = hl_types_ArrayObj_remove(r2,((vdynamic*)r9));
	r9 = (String)s$__implementedBy__;
	r10 = hl_types_ArrayObj_remove(r2,((vdynamic*)r9));
	return r2;
}
...
venum* Type_typeof(vdynamic* r0) {
	...
	switch(r3) {
		...
		case 6:
			...
			if( r5 != r6 ) goto label$9fea9d9_19_15;
			r4 = (venum*)g$ValueType_TInt;
			return r4;
			label$9fea9d9_19_15:
		...
		case 11:
			...
			if( r7 == ((hl__Class)r8) ) goto label$9fea9d9_19_25;
			if( r7 ) goto label$9fea9d9_19_27;
			label$9fea9d9_19_25:
		...
		case 15:
			r2 = hl_get_virtual_value(r0);
			if( r2 ) goto label$9fea9d9_19_34;
			r4 = (venum*)g$ValueType_TObject;
			return r4;
			label$9fea9d9_19_34:
			r4 = Type_typeof(r2);
...
String Type_enumConstructor(vdynamic* r0) {
	...
	r6 = r4->length;
	if( ((unsigned)r5) < ((unsigned)r6) ) goto label$9fea9d9_20_10;
	r7 = NULL;
	goto label$9fea9d9_20_13;
	label$9fea9d9_20_10:
	r8 = r4->array;
	r2 = ((vdynamic**)(r8 + 1))[r5];
	r7 = (String)r2;
