...
vvirtual* EReg_matchedPos(EReg r0) {
	...
	r2 = hl_regexp_matched_pos(r3,r2,r4);
	r5 = 0;
	if( r2 >= r5 ) goto label$6d09180_5_9;
	r6 = NULL;
	return r6;
	label$6d09180_5_9:
...
bool EReg_matchSub(EReg r0,String r1,int r2,int* r3) {
	...
	vbyte *r7;
	int r4, r9, r10;
	if( r3 ) goto label$6d09180_6_3;
	r4 = -1;
	goto label$6d09180_6_4;
	label$6d09180_6_3:
	r4 = *r3;
	label$6d09180_6_4:
	r6 = r0->r;
	...
	r7 = r1->bytes;
	r10 = 0;
	if( r4 >= r10 ) goto label$6d09180_6_12;
	r9 = r1->length;
	r9 = r9 - r2;
	goto label$6d09180_6_13;
	label$6d09180_6_12:
	r9 = r4;
	label$6d09180_6_13:
	r5 = hl_regexp_match(r6,r7,r2,r9);
	if( !r5 ) goto label$6d09180_6_17;
	r0->last = r1;
	goto label$6d09180_6_19;
	label$6d09180_6_17:
	r8 = NULL;
	r0->last = r8;
	label$6d09180_6_19:
...
hl__types__ArrayObj EReg_split(EReg r0,String r1) {
	...
	r15 = 0;
	if( r11 != r15 ) goto label$6d09180_7_24;
	if( r7 ) goto label$6d09180_7_24;
	r15 = r1->length;
	if( r12 != r15 ) goto label$6d09180_7_23;
	goto label$6d09180_7_41;
	label$6d09180_7_23:
	++r12;
	label$6d09180_7_24:
	...
	r7 = r8;
	r8 = r0->global;
	if( r8 ) goto label$6d09180_7_40;
	goto label$6d09180_7_41;
	label$6d09180_7_40:
	goto label$6d09180_7_6;
	label$6d09180_7_41:
	if( r6 == NULL ) hl_null_access();
	r16 = hl_alloc_dynamic(&t$_i32);
	r16->v.i = r4;
...
String EReg_replace(EReg r0,String r1,String r2) {
	...
	if( !r11 ) goto label$6d09180_8_153;
	r14 = 0;
	r12 = r0->r;
	r15 = 0;
	r16 = &r14;
	...
	r18 = 0;
	if( r14 != r18 ) goto label$6d09180_8_27;
	if( r10 ) goto label$6d09180_8_27;
	r18 = r1->length;
	if( r15 != r18 ) goto label$6d09180_8_26;
	goto label$6d09180_8_153;
	label$6d09180_8_26:
	++r15;
	label$6d09180_8_27:
	if( r3 == NULL ) hl_null_access();
	...
	r17 = r8->length;
	r18 = 0;
	if( r18 >= r17 ) goto label$6d09180_8_44;
	r17 = 0;
	r18 = r8->length;
	if( ((unsigned)r17) < ((unsigned)r18) ) goto label$6d09180_8_40;
	r7 = NULL;
	goto label$6d09180_8_43;
	label$6d09180_8_40:
	r22 = r8->array;
	...
	if( r8 == NULL ) hl_null_access();
	r19 = r8->length;
	if( r17 >= r19 ) goto label$6d09180_8_141;
	r19 = r8->length;
	if( ((unsigned)r17) < ((unsigned)r19) ) goto label$6d09180_8_53;
	r7 = NULL;
	goto label$6d09180_8_56;
	label$6d09180_8_53:
	r22 = r8->array;
	r21 = ((vdynamic**)(r22 + 1))[r17];
	r7 = (String)r21;
	...
	r23 = 49;
	if( r18 < r23 ) goto label$6d09180_8_115;
	r23 = 57;
	if( r23 < r18 ) goto label$6d09180_8_115;
	r19 = 0;
	hl_trap(trap$0,r21,label$6d09180_8_74);
	r12 = r0->r;
	r24 = (int)r18;
	r25 = 48;
	r24 = r24 - r25;
	...
	if( !r11 ) goto label$6d09180_8_94;
	...
	if( !r11 ) goto label$6d09180_8_92;
	r24 = -1;
	goto label$6d09180_8_93;
	label$6d09180_8_92:
	...
	label$6d09180_8_95:
	r25 = 0;
	if( r24 >= r25 ) goto label$6d09180_8_102;
	if( r3 == NULL ) hl_null_access();
	r27 = (String)s$c3e97dd;
	StringBuf_add(r3,((vdynamic*)r27));
	StringBuf_add(r3,((vdynamic*)r7));
	goto label$6d09180_8_114;
	label$6d09180_8_102:
	r25 = 0;
	if( r24 < r25 ) goto label$6d09180_8_107;
	if( r3 == NULL ) hl_null_access();
	r20 = hl_alloc_dynamic(&t$_i32);
	r20->v.i = r19;
	...
	label$6d09180_8_114:
	goto label$6d09180_8_139;
	label$6d09180_8_115:
	r24 = 0;
	if( r18 != r24 ) goto label$6d09180_8_135;
	if( r3 == NULL ) hl_null_access();
	r9 = (String)s$c3e97dd;
	StringBuf_add(r3,((vdynamic*)r9));
	++r17;
	r24 = r8->length;
	if( ((unsigned)r17) < ((unsigned)r24) ) goto label$6d09180_8_125;
	r9 = NULL;
	goto label$6d09180_8_128;
	label$6d09180_8_125:
	r22 = r8->array;
	r21 = ((vdynamic**)(r22 + 1))[r17];
	r9 = (String)r21;
	label$6d09180_8_128:
	if( !r9 ) goto label$6d09180_8_134;
	if( r9 == NULL ) hl_null_access();
	r23 = r9->length;
	r24 = 0;
	if( r24 >= r23 ) goto label$6d09180_8_134;
	StringBuf_add(r3,((vdynamic*)r9));
	label$6d09180_8_134:
	goto label$6d09180_8_139;
	label$6d09180_8_135:
	...
	r10 = r11;
	r11 = r0->global;
	if( r11 ) goto label$6d09180_8_152;
	goto label$6d09180_8_153;
	label$6d09180_8_152:
	goto label$6d09180_8_9;
	label$6d09180_8_153:
	if( r3 == NULL ) hl_null_access();
	r20 = hl_alloc_dynamic(&t$_i32);
	r20->v.i = r6;
...
String EReg_map(EReg r0,String r1,vclosure* r2) {
	...
	r3 = 0;
	r5 = (StringBuf)hl_alloc_obj(&t$StringBuf);
	StringBuf_new(r5);
	label$6d09180_9_3:
	r6 = true;
	if( !r6 ) goto label$6d09180_9_47;
	if( r1 == NULL ) hl_null_access();
	r8 = r1->length;
	if( r3 < r8 ) goto label$6d09180_9_10;
	goto label$6d09180_9_47;
	label$6d09180_9_10:
	r10 = NULL;
	r6 = EReg_matchSub(r0,r1,r3,r10);
	if( r6 ) goto label$6d09180_9_18;
	if( r5 == NULL ) hl_null_access();
	r11 = NULL;
	...
	StringBuf_add(r5,((vdynamic*)r9));
	r14 = 0;
	if( r7 != r14 ) goto label$6d09180_9_41;
	r14 = 1;
	r11 = hl_alloc_dynamic(&t$_i32);
	r11->v.i = r14;
	...
	r13 = r8 + r14;
	r3 = r13;
	goto label$6d09180_9_43;
	label$6d09180_9_41:
	r13 = r8 + r7;
	r3 = r13;
	label$6d09180_9_43:
	r6 = r0->global;
	if( r6 ) goto label$6d09180_9_46;
	goto label$6d09180_9_47;
	label$6d09180_9_46:
	goto label$6d09180_9_3;
	label$6d09180_9_47:
	r6 = r0->global;
	if( r6 ) goto label$6d09180_9_58;
	r13 = 0;
	if( r13 >= r3 ) goto label$6d09180_9_58;
	if( r1 == NULL ) hl_null_access();
	r13 = r1->length;
	if( r3 >= r13 ) goto label$6d09180_9_58;
	if( r5 == NULL ) hl_null_access();
	r11 = NULL;
	r9 = String_substr(r1,r3,r11);
	StringBuf_add(r5,((vdynamic*)r9));
