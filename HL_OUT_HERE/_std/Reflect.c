...
vdynamic* Reflect_callMethod(vdynamic* r0,vdynamic* r1,hl__types__ArrayDyn r2) {
	...
	r6 = r4->kind;
	r8 = 10;
	if( r6 == r8 ) goto label$0858e10_6_9;
	...
	if( r6 >= r8 ) goto label$0858e10_6_17;
	r12 = r8;
	goto label$0858e10_6_18;
	label$0858e10_6_17:
	r12 = r6;
	label$0858e10_6_18:
	r5 = hl_get_closure_value(r1);
	if( !r5 ) goto label$0858e10_6_23;
	...
	if( r5 ) goto label$0858e10_6_37;
	r13 = 0;
	r16 = r6;
	label$0858e10_6_28:
	if( r13 >= r16 ) goto label$0858e10_6_36;
	r17 = r13;
	++r13;
	if( r3 == NULL ) hl_null_access();
	r14 = hl_types_ArrayDyn_getDyn(r3,r17);
	((vdynamic**)(r15 + 1))[r17] = r14;
	goto label$0858e10_6_28;
	label$0858e10_6_36:
	goto label$0858e10_6_51;
	label$0858e10_6_37:
	r13 = 0;
	...
	r16 = r6;
	label$0858e10_6_41:
	if( r13 >= r16 ) goto label$0858e10_6_51;
	r17 = r13;
	++r13;
	if( r3 == NULL ) hl_null_access();
	r14 = hl_types_ArrayDyn_getDyn(r3,r17);
