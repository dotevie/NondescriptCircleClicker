...
void StringBuf_addChar(StringBuf r0,int r1) {
	...
	int r3, r4, r9, r11;
	r4 = 0;
	if( r1 < r4 ) goto label$d4ab3a5_4_45;
	r4 = 65536;
	if( r1 >= r4 ) goto label$d4ab3a5_4_45;
	r4 = 55296;
	if( r1 < r4 ) goto label$d4ab3a5_4_15;
	r4 = 57343;
	if( r4 < r1 ) goto label$d4ab3a5_4_15;
	r5 = (String)s$Invalid_unicode_char_;
	r3 = r1;
	r6 = &r3;
	r7 = hl_itos(r3,r6);
	...
	r3 = r3 + r4;
	r4 = r0->size;
	if( r4 >= r3 ) goto label$d4ab3a5_4_37;
	r3 = r0->size;
	r4 = 3;
	r3 = r3 * r4;
	r4 = 1;
	r3 = r3 >> r4;
	r4 = 0;
	if( r3 >= r4 ) goto label$d4ab3a5_4_29;
	r4 = 0;
	r3 = r4;
	label$d4ab3a5_4_29:
	...
	*(unsigned short*)(r7 + r3) = (unsigned short)r1;
	...
	r3 = r3 + r4;
	r0->pos = r3;
	goto label$d4ab3a5_4_100;
	label$d4ab3a5_4_45:
	r4 = 1114112;
	if( r1 >= r4 ) goto label$d4ab3a5_4_93;
	r3 = r0->pos;
	r4 = 4;
	r3 = r3 + r4;
	r4 = r0->size;
	if( r4 >= r3 ) goto label$d4ab3a5_4_69;
	r3 = r0->size;
	r4 = 3;
	r3 = r3 * r4;
	r4 = 1;
	r3 = r3 >> r4;
	r4 = 0;
	if( r3 >= r4 ) goto label$d4ab3a5_4_61;
	r4 = 0;
	r3 = r4;
	label$d4ab3a5_4_61:
	r7 = hl_alloc_bytes(r3);
