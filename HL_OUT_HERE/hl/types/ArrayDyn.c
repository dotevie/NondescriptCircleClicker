...
hl__types__ArrayDyn hl_types_ArrayDyn_concat(hl__types__ArrayDyn r0,hl__types__ArrayDyn r1) {
	...
	r10 = r5;
	label$a6944e8_6_12:
	if( r7 >= r10 ) goto label$a6944e8_6_20;
	r11 = r7;
	++r7;
	if( r2 == NULL ) hl_null_access();
	r13 = ((vdynamic* (*)(hl__types__ArrayBase,int))r2->$type->vobj_proto[0])(r2,r11);
	((vdynamic**)(r8 + 1))[r11] = r13;
	goto label$a6944e8_6_12;
	label$a6944e8_6_20:
	r7 = 0;
	if( r3 == NULL ) hl_null_access();
	r10 = r3->length;
	label$a6944e8_6_23:
	if( r7 >= r10 ) goto label$a6944e8_6_32;
	r11 = r7;
	++r7;
	if( r3 == NULL ) hl_null_access();
...
hl__types__ArrayDyn hl_types_ArrayDyn_copy(hl__types__ArrayDyn r0) {
	...
	r6 = r2->length;
	label$a6944e8_24_9:
	if( r3 >= r6 ) goto label$a6944e8_24_18;
	r7 = r3;
	++r3;
	r2 = r0->array;
	if( r2 == NULL ) hl_null_access();
...
haxe__iterators__ArrayKeyValueIterator hl_types_ArrayDyn_keyValueIterator(hl__types__ArrayDyn r0) {
	...
	r2 = r0->array;
	r3 = (hl__types__ArrayDyn)hl_dyn_castp(&r2,&t$hl_types_ArrayBase,&t$hl_types_ArrayDyn);
...
hl__types__ArrayDyn hl_types_ArrayDyn_map(hl__types__ArrayDyn r0,vclosure* r1) {
	...
	r7 = r3->length;
	label$a6944e8_27_9:
	if( r4 >= r7 ) goto label$a6944e8_27_20;
	r8 = r4;
	++r4;
	if( r1 == NULL ) hl_null_access();
	r3 = r0->array;
