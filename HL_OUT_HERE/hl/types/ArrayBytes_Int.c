...
void hl_types_ArrayBytes_Int_blit(hl__types__ArrayBytes_Int r0,int r1,hl__types__ArrayAccess r2,int r3,int r4) {
	...
	r8 = r5->length;
	if( r8 >= r7 ) goto label$d0a53a9_9_16;
	label$d0a53a9_9_14:
...
haxe__iterators__ArrayKeyValueIterator hl_types_ArrayBytes_Int_keyValueIterator(hl__types__ArrayBytes_Int r0) {
	...
	r2 = (hl__types__ArrayDyn)hl_dyn_castp(&r0,&t$hl_types_ArrayBytes_Int,&t$hl_types_ArrayDyn);
...
void hl_types_ArrayBytes_Int___expand(hl__types__ArrayBytes_Int r0,int r1) {
	...
	r4 = 0;
	if( r1 >= r4 ) goto label$d0a53a9_36_9;
	...
	r3 = r1 + r4;
	r9 = r0->size;
	if( r9 >= r3 ) goto label$d0a53a9_36_40;
	r4 = r0->size;
	r9 = 3;
	r4 = r4 * r9;
	r9 = 1;
	r4 = r4 >> r9;
	if( r4 >= r3 ) goto label$d0a53a9_36_20;
	r4 = r3;
	label$d0a53a9_36_20:
	r7 = r0->bytes;
	r10 = 2;
